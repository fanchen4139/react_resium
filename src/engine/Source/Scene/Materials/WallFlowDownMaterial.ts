...
import WallFlowDownShader from "../Shaders/Materials/WallFlowDown.glsl";

// 定义材质类型和 Shader
Material.WallFlowDownType = "WallFlowDown";

// 注册材质
Material._materialCache.addMaterial(Material.WallFlowDownType, {
  fabric: {
    type: Material.WallFlowDownType,
    uniforms: {
      image: Material.DefaultImageId, //选择自己的动态材质图片
      color: Color.TRANSPARENT,
      speed: 1.0,
    },
    source: WallFlowDownShader,
    /**
