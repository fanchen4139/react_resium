 ...
 * - 用 Leva 控制 LabelCollection 属性
 * - 需放在 <Viewer> 或 <CesiumWidget> 内使用
 */
const LabelCollectionWithLeva: React.FC<{ children?: React.ReactNode }> = ({
  children,
}) => {
  const params = useLevaControls({
    name: "LabelCollection 控制",
    schema: {
      basic: folder(
        {
...
export default memo(LabelCollectionWithLeva)
