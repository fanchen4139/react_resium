...
// 定义材质类型和 Shader
Material.WallFlowCounterclockwiseType = "WallFlowCounterclockwise";

// 注册材质
Material._materialCache.addMaterial(Material.WallFlowCounterclockwiseType, {
  fabric: {
    type: Material.WallFlowCounterclockwiseType,
    uniforms: {
